...
# 加载预测数据
PREDICT_PATH = "./data/all_predict_value.csv"
...
result_df.to_csv("./约束违反/balance.csv", index=False, encoding='gb18030')

print(f"处理完成，发现{len(violations)}处供电缺口，结果路径：./约束违反/balance.csv")
